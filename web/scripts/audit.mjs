// 视觉一致性回归护栏（TDD 守护）：
//   A. 水墨画布：移动端 180% 放大贴顶随滚动、桌面端 160% 放大同样随滚动，下滑可见图片下方（用户的明确要求）
...
// ---------- A. 画布背景规格 ----------
console.log("A. 画布背景：全端随文档滚动，移动端 180% 放大贴顶、桌面端 160% 放大")
...
assertFile(css.includes("position: absolute"), "canvas-bg 全端起效 absolute（随文档纵向滚动，下滑可见图片下方）")
